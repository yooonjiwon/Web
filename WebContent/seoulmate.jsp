...
<body id="page30">
	...
	<!-- content -->
	<form id="form" name="form" action="/qna?curPage=1" method="post"><section id="content">

		<div class="mb25 cnt-blockquote-blue desc-qna">
	Visit Seoul에 관해서 또는 서울 관광에 관해서 궁금하신 사항을 질문해주세요. <br>어떤 질문이든 환영하며, 신속하게 답변 드리겠습니다.
</div>
<div class="box-tabcontent">
			<div id="tab-cont-header2">
				<div class="set-button">
					<a href="#none" class="button middle blue bold" id="btnCreate">
						질문등록<span class="ion-chevron-right"></span>
					</a>
			...
			<% for (Guide guide : guides) { %>
				<div class="cnt-faqitem qna">
					<div class="header">
						...
						<img src="/humanframe/theme/visitseoul/assets/images/ico/ico-mail.png" alt="이메일 보내기" /></span>
						<img src="../images/listline.jgp">
					</div>
					</div>
			<% } %>
