...
<head>
	...
	$(function() {
		$('a#delete').on('click', function(event) {
			...
			if (ok) {
				location.href = "contactsdelete.action?boardno=" + boardNo;
			}
                                        ...
                                        <div class="wrapper">
											...
											" />
													        ...
													        <c:if test="${ board.writer eq loginuser.memberId or loginuser.memberId eq 'admin' }">
													        	...
													        	[&nbsp;<a href='contactsedit.action?boardno=${ board.boardNo }&pageno=${ pageno }'>수정</a>&nbsp;]      
													        </c:if>
													        <c:if test="${ loginuser.memberId eq 'admin' }">		
													        	[&nbsp;<a href='contactsreply.action?boardno=${ board.boardNo }'>답글쓰기</a>&nbsp;]
													        </c:if>
