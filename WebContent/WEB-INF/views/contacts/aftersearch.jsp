...
<head>
	...
	$(function() {
		$('button#search').on('click', function(event){
			...
			location.href= 'aftersearch.action?pageno=1&search1=' + search1 + '&search2=' + search2;
		});
													...
													<table border="1" align="center">
														...
														<tr style="height:25px">
															...
															<!--  게시글 목록중 하나를 눌렀을 때 내용으로 넘어가는 작업 1단계 Rewrite -->
																<a href='afterdetail.action?boardno=${ board.boardNo }&pageno=${ pageno }' style='text-decoration: none'>
																	${ board.title }
																</a>
															<%-- <% } else { --%>
															</c:when>
