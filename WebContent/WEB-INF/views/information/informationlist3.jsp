...
<script type="text/javascript">
	$(function() { //jQuery's main function
		$('#write').on('click', function(event) {
			location.href = '/seoul/information/write33.action';
		});
	});
</script>
		...
		<div class="bg-top">
			<div class="bg-top-2">
											...
											<div class="grid_12">
												<div class="wrapper">
													...
													<article class="grid_8 omega">
														<span style=" font-weight: bold; font-size: 1.5em; line-height: 0.8em; color: gray; font-family: arial ">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[강동, 송파]<br><br></span>
				...
				<!-- ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ삭제 글일경우ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ -->
																		...
																		<% } else { //삭제되지 않은 글 %>
																		<a href="detail33.action?boardno=<%=information.getIn_No()%>&pageno=<%=request.getAttribute("pageno")%>"
