	...
	<div id="pageContainer">
		...
		<div id="inputcontent">
		    <div id="inputmain">
		        ...
		        <form id="updateform" action="update37.action" method="post">
		        ...
		        <div class="buttons">
		        	...
		        	&nbsp;&nbsp;
		        	<a href='/seoul/information/detail37.action?boardno=<%= board.getIn_No() %>&pageno=<%= request.getAttribute("pageno") %>'>취소</a>
		        	&nbsp;&nbsp;
