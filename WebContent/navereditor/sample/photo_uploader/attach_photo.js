    ...
    function html5Upload() {
    	...
    	sUploadURL= '/seoul/galleryimageupload2.action'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			...
 			sUrl  : '/seoul/galleryimageupload.action',
 			sCallback : '/seoul/navereditor/sample/photo_uploader/callback.html',
