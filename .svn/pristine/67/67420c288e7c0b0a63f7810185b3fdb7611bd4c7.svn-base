...
@WebServlet(value = "/contacts/contactsedit.action")
...
//		}
		...
		RequestDispatcher dispatcher = 
			req.getRequestDispatcher("/WEB-INF/views/contacts/contactsedit.jsp");
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		resp.sendRedirect("contactsdetail.action?boardno=" + boardNo);
	}
