...
@WebServlet(value = "/information/delete36.action")
public class InformationDeleteServlet6 extends HttpServlet {
...
//		}
		...
		boardService.deleteBoardNo6(boardNo);
		
		//3. list.action으로 이동		 
		resp.sendRedirect("list36.action");		
	}
}
