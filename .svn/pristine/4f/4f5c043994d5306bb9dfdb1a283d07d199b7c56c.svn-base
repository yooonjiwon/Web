...
@WebServlet(value = "/information/list34.action")
public class InformationListServlet4 extends HttpServlet {
...
///////////////////////// 서비스로 넘겨 /////////////////////
		...
		List<Information> boards = boardService.findBoardList4(); //List<Board> : 리스트 목록이 한건이 아니고 여러건이기때문에 씀(복수처리)
		
		//페이저 기능도 서비스로 넘겨
		boardCount = boardService.getBoardCount4();
...
//////////////////////////////////////////////////////////////		
		...
		RequestDispatcher dispatcher = 
			req.getRequestDispatcher("/WEB-INF/views/information/informationlist4.jsp");
