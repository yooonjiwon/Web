...
@WebServlet(value = "/information/detail3.action")
public class InformationDetailServlet extends HttpServlet {
...
//		}
		...
		try {
			...
			resp.sendRedirect("/seoul/information/list3.action");
			return;
		}
		...
		Information information = boardService.findBoardByBoardNo(boardNo);
			if (information == null) {
				resp.sendRedirect("/seoul/information/list3.action");
				return;
			}
		...
		RequestDispatcher dispatcher = 
			req.getRequestDispatcher("/WEB-INF/views/information/informationdetail.jsp");
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		resp.sendRedirect("/seoul/information/detail3.action?boardno=" + boardNo);
	}	
}
