...
@WebServlet(value = "/information/update37.action")
public class InformationUpdateServlet7 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		Information board = boardService.findBoardByBoardNo7(boardNo);
			if (board == null) {
				resp.sendRedirect("/seoul/information/list37.action");
				return;
			}
		...
		RequestDispatcher dispatcher = 
			req.getRequestDispatcher("/WEB-INF/views/information/informationedit7.jsp");
