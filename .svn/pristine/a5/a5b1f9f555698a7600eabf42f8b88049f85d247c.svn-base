...
@WebServlet(value = "/information/update32.action")
public class InformationUpdateServlet2 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		Information board = boardService.findBoardByBoardNo2(boardNo);
			if (board == null) {
				resp.sendRedirect("/seoul/information/list32.action");
				return;
			}
		...
		RequestDispatcher dispatcher = 
			req.getRequestDispatcher("/WEB-INF/views/information/informationedit2.jsp");
