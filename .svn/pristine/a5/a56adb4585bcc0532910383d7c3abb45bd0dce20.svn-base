...
@WebServlet(value = "/information/delete37.action")
public class InformationDeleteServlet7 extends HttpServlet {
...
//		}
		...
		boardService.deleteBoardNo7(boardNo);
		
		//3. list.action으로 이동		 
		resp.sendRedirect("list37.action");		
	}
}
