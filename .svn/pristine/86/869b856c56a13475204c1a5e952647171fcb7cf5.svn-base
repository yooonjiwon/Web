...
@WebServlet(value = "/information/delete34.action")
public class InformationDeleteServlet4 extends HttpServlet {
...
//		}
		...
		boardService.deleteBoardNo4(boardNo);
		
		//3. list.action으로 이동		 
		resp.sendRedirect("list34.action");		
	}
}
