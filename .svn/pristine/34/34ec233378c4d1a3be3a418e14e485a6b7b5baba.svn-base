...
@WebServlet(value = "/information/detail36.action")
public class InformationDetailServlet6 extends HttpServlet {
...
//		}
		...
		try {
			...
			resp.sendRedirect("/seoul/information/list36.action");
			return;
		}
		...
		Information information = boardService.findBoardByBoardNo6(boardNo);
			if (information == null) {
				resp.sendRedirect("/seoul/information/list36.action");
				return;
			}
		...
		boardService.increaseReadCount6(boardNo);
		...
		RequestDispatcher dispatcher = 
			req.getRequestDispatcher("/WEB-INF/views/information/informationdetail6.jsp");
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//사용자 수정 처리
		InformationBoardService boardService = new InformationBoardService();
		boardService.updateBoard6(board);
		resp.sendRedirect("/seoul/information/detail36.action?boardno=" + boardNo);
	}	
}
