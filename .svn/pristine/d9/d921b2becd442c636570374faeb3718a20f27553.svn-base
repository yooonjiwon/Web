...
@WebServlet(value = "/contacts/afterdetail.action")
public class AfterDetailServlet extends HttpServlet {
...
//		}
		...
		try {
			...
			resp.sendRedirect("afterdetail.action");
			return;
		}
		...
		RequestDispatcher dispatcher = 
			req.getRequestDispatcher("/WEB-INF/views/contacts/afterdetail.jsp");
