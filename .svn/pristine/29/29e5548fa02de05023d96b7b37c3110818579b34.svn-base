...
@WebServlet(value = "/information/write33.action")
public class InformationWriteServlet3 extends HttpServlet {
...
//		}
		...
		RequestDispatcher dispatcher = 
			req.getRequestDispatcher("/WEB-INF/views/information/informationwrite3.jsp");
...
/*		String sBoardNo = req.getParameter("boardno");
		...
		boardService.writeBoard3(information);
