												...
												<div style="padding-top:25px;text-align:center">
													<div id="inputcontent">	
													    <div id="inputmain">
													        ...
													        <form id="replyform" action="contactsreply.action" method="post">
													        ...
													        <table>
													            ...
													            <tr>
													                ...
													                <td>
													                	${ loginuser.memberId }
													                	<!-- input type="hidden" : 서버로 전송하지만 브라우저에 표시되지 않는 요소 -->										 		<!-- 방법 1 -->
													                	<input type="hidden" name="writer" value="${ loginuser.memberId }">	<!-- 방법 2(getParameter) : 브라우저에서 전송된 데이터 읽기 -->
													                </td>
													            </tr>
													            <tr>
													                <th>내용</th>
													        ...
													        <div class="buttons">
													        	...
													        	&nbsp;&nbsp;
													        	<a href="contactslist.action">목록보기</a>
