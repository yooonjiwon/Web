                	...
                	<div class="grid_12">
                    	<nav>
                            <ul class="menu">
                                ...
                                <li><a href="list.action">Seoul mate</a></li>
                                <li><a href="/board/turelist.action">Turelist</a></li>
        ...
        <div class="row-2">
        	<div class="main">
            	<div class="container_12">
                	<div class="grid_9">
                    	<h1>
                            <a class="logo" href="index.jsp">hello<strong>♡</strong>seoul</a>
                    ...
                    <div class="grid_3">
                        ...
                        <div class="links">
                     		...
                     		<% if (member == null) { %>
                             <a href="/seoul/account/login.action" style="font-size: 25px" ><span>Login</span></a>	
                             <a href="/seoul/account/signup.action" style="font-size: 25px" ><span>Signup</span></a>
                     		<% } else { %>
                     		 <%= member.getName() %>
                     		 <a href="/seoul/account/logout.action">Signout</a> 
                     		<% } %>
                                ...
                                <div class="inner">
                                    <div class="wrapper">
                                        ...
                                        <div class="extra-wrap indent-top2">
                                        	<strong>Interior Design</strong> is one of <a target="_blank" href="http://blog.templatemonster.com/free-website-templates/ ">free website templates</a> created by TemplateMonster.com team. This website template is opti mized for 1024X768 screen resolution. It is also XHTML &amp; CSS valid. It has several pages: <a class="color-3" href="index.jsp">About</a>, <a class="color-3" href="information.jsp">Information</a>, <a class="color-3" href="catalogue.jsp">Catalogue</a>, <a class="color-3" href="pricing.jsp">Pricing</a>, <a class="color-3" href="contacts.jsp">Contact Us</a> (note that contact us form – doesn’t work).
                                        </div>
                                    </div>
                                </div>
                            </div>
