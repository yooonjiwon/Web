...
@WebServlet(value = "/information/write36.action")
public class InformationWriteServlet6 extends HttpServlet {
...
//		}
		...
		RequestDispatcher dispatcher = 
			req.getRequestDispatcher("/WEB-INF/views/information/informationwrite6.jsp");
...
/*		String sBoardNo = req.getParameter("boardno");
		...
		boardService.writeBoard6(information);
