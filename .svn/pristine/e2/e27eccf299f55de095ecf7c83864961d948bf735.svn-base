...
<head>
	...
	$(function() {
		$('a#delete').on('click', function(event) {
			...
			if (ok) {
				location.href = "quedelete.action?boardno=" + boardNo;
			}
                                        ...
                                        <div class="wrapper">
											...
											" />
													        ...
													        <c:if test="${ board.writer eq loginuser.memberId or loginuser.memberId eq 'admin' }">
													        	...
													        	[&nbsp;<a href='queedit.action?boardno=${ board.boardNo }&pageno=${ pageno }'>수정</a>&nbsp;]      
													        </c:if>	
													        	[&nbsp;<a href='quereply.action?boardno=${ board.boardNo }'>답글쓰기</a>&nbsp;]
