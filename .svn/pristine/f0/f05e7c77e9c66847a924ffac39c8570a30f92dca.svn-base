...
@WebServlet(value = "/contacts/quesearch.action")
public class QueSearchServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		int pagerSize = 3;
		int boardCount = 0;
		String linkUrl = "quesearch.action";
		...
		List<ContactsBoard> boards = boardService.findBoardList7(search1, search2, first, last);//추가**
		
		boardCount = boardService.getBoardCount7(search1, search2);
		...
		RequestDispatcher dispatcher = 
			req.getRequestDispatcher("/WEB-INF/views/contacts/quesearch.jsp");
