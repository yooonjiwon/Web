...
@WebServlet(value = "/myconnect.action")
public class TureMyConnectServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		TureBoard connections = boardService.findMyConnection(member.getMemberId());
		...
		RequestDispatcher dispatcher = 
			req.getRequestDispatcher("/WEB-INF/views/tureboard/connection.jsp");
