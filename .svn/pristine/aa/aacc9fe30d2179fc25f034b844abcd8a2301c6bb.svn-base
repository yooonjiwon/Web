...
@WebServlet(value = "/contacts/quedetail.action")
public class QueDetailServlet extends HttpServlet {
...
//		}
		...
		try {
			...
			resp.sendRedirect("quedetail.action");
			return;
		}
		...
		RequestDispatcher dispatcher = 
			req.getRequestDispatcher("/WEB-INF/views/contacts/quedetail.jsp");
