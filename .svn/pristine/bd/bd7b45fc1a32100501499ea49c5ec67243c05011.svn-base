...
@WebServlet(value = "/galleryimageupload.action")
public class GalleryImageUploadServlet extends HttpServlet {
			    ...
			    for (FileItem item : items) {
			        if(item.getFieldName().equals("callback")) {
			            ...
			            if(item.getSize() > 0) {
			                ...
			                os.close();
			                ///////////////// 서버에 파일쓰기 /////////////////
			                return3 += "&bNewLine=true&sFileName="+name+"&sFileURL=/seoul/upload/"+realname;
			            }else {
