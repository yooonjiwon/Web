...
@WebServlet(value = "/information/detail34.action")
public class InformationDetailServlet4 extends HttpServlet {
...
//		}
		...
		Information information = boardService.findBoardByBoardNo4(boardNo);
			if (information == null) {
				resp.sendRedirect("/seoul/information/list34.action");
				return;
			}
		...
		boardService.increaseReadCount4(boardNo);
		...
		RequestDispatcher dispatcher = 
			req.getRequestDispatcher("/WEB-INF/views/information/informationdetail4.jsp");
