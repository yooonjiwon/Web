...
@WebServlet(value = "/information/detail37.action")
public class InformationDetailServlet7 extends HttpServlet {
...
//		}
		...
		try {
			...
			resp.sendRedirect("/seoul/information/list37.action");
			return;
		}
		...
		Information information = boardService.findBoardByBoardNo7(boardNo);
			if (information == null) {
				resp.sendRedirect("/seoul/information/list37.action");
				return;
			}
		...
		boardService.increaseReadCount7(boardNo);
		...
		RequestDispatcher dispatcher = 
			req.getRequestDispatcher("/WEB-INF/views/information/informationdetail7.jsp");
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//사용자 수정 처리
		InformationBoardService boardService = new InformationBoardService();
		boardService.updateBoard7(board);
		resp.sendRedirect("/seoul/information/detail37.action?boardno=" + boardNo);
	}	
}
