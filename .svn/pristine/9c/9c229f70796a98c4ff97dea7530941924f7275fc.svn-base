...
@WebServlet(value = "/contacts/afterlist.action")
public class AfterListServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		int pagerSize = 3;
		int boardCount = 0;
		String linkUrl = "afterlist.action";
		...
		List<ContactsBoard> boards = boardService.findBoardList4(first, last);//추가**
		...
		RequestDispatcher dispatcher = 
			req.getRequestDispatcher("/WEB-INF/views/contacts/afterlist.jsp");
