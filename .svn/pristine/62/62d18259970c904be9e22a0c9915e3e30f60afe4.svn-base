...
@WebServlet(value = "/information/detail33.action")
public class InformationDetailServlet3 extends HttpServlet {
...
//		}
		...
		Information information = boardService.findBoardByBoardNo3(boardNo);
			if (information == null) {
				resp.sendRedirect("/seoul/information/list33.action");
				return;
			}
		...
		boardService.increaseReadCount3(boardNo);
		...
		RequestDispatcher dispatcher = 
			req.getRequestDispatcher("/WEB-INF/views/information/informationdetail3.jsp");
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		resp.sendRedirect("/seoul/information/detail33.action?boardno=" + boardNo);
	}	
}
