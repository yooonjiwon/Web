...
@WebServlet(value = "/information/write32.action")
public class InformationWriteServlet2 extends HttpServlet {
...
//		}
		...
		RequestDispatcher dispatcher = 
			req.getRequestDispatcher("/WEB-INF/views/information/informationwrite2.jsp");
...
/*		String sBoardNo = req.getParameter("boardno");
		...
		boardService.writeBoard2(information);
