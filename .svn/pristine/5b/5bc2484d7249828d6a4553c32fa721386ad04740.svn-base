...
@WebServlet(value = "/information/write38.action")
public class InformationWriteServlet8 extends HttpServlet {
...
//		}
		...
		RequestDispatcher dispatcher = 
			req.getRequestDispatcher("/WEB-INF/views/information/informationwrite8.jsp");
...
/*		String sBoardNo = req.getParameter("boardno");
		...
		boardService.writeBoard8(information);
