...
<head>
	...
	$(function() {
		$('input#submitbtn').on('click', function(event) {
...
<body id="page30">
    ...
    <div class="indent-left p2">
		...
		<span class="chyron"><a href="/seoul/seoulmate/list.action">&laquo; 돌아가기</a></span>
		<h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		    [Change Guide Application]</h2>
		    
		<form name="hongkiat" id="hongkiat-form" action="update.action" method="post">
		
		<div id="wrapping" class="clearfix">
			<section id="aligned">
			<%-- <% Guide guide = (Guide)request.getAttribute("guide"); %>
			<% Member member = (Member)session.getAttribute("loginuser"); %> --%>
			<input type="hidden" name="gub_boardno" value="${ guide.gub_BoardNo }" >
			
			<input type="text" name="gub_writer" id="writer"  autocomplete="off" tabindex="1" class="txtinput" value="${ member.memberId }" readonly>
			
			<input type="text" name="gub_name" id="name" placeholder="Your name" autocomplete="off" tabindex="1" class="txtinput" value="${ guide.gub_Name }">
		
			<input type="email" name="gub_email" id="email" placeholder="Your e-mail address" autocomplete="off" tabindex="2" class="txtinput" value="${ guide.gub_Email }">
		
			<input type="text" name="gub_passno" id="pass" placeholder="Passport No(Optional)" autocomplete="off" tabindex="1" class="txtinput" value="${ guide.gub_PassNo }">
		
			<input type="tel" name="gub_phone" id="telephone" placeholder="Phone number" tabindex="4" class="txtinput" value="${ guide.gub_Phone }">
			
			<h4>주요 가이드 희망 분야 </h4>
			<select id="hopearea" name="gub_hopearea" tabindex="6" class="selmenu">
  				<option value="${ guide.gub_HopeArea }">${ guide.gub_HopeArea }</option>
			...
			<input type="text" name="gub_title" id="title" placeholder="Title" tabindex="4" class="txtinput" value="${ guide.gub_Title }">
			
			<textarea name="gub_intro" id="intro" placeholder="Intro" tabindex="5" class="txtblock">${ guide.gub_Intro }</textarea>
			</section>
  		  ...
  		  <option value="${ guide.gub_Nation }">${ guide.gub_Nation }</option>
          ...
          <option value="zimbabwean">Zimbabwean</option>
				...
				<section id="prioritycase">
					<h4>희망 대상(Target): ${ guide.gub_Target }</h4><br>
					...
					<span class="radiobadge">
						...
						<label for="외국인(Foreign)">외국인(Foreign)</label>
					</span>
