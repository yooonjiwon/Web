...
@WebServlet(value = "/contacts/eventedit.action")
...
//		}
		...
		RequestDispatcher dispatcher = 
			req.getRequestDispatcher("/WEB-INF/views/contacts/eventedit.jsp");
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		resp.sendRedirect("eventdetail.action?boardno=" + boardNo);
	}
