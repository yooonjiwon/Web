...
@WebServlet(value = "/contacts/contactsdetail.action")
public class ContactsDetailServlet extends HttpServlet {
...
//		}
		...
		try {
			...
			resp.sendRedirect("contactsdetail.action");
			return;
		}
		...
		RequestDispatcher dispatcher = 
			req.getRequestDispatcher("/WEB-INF/views/contacts/contactsdetail.jsp");
