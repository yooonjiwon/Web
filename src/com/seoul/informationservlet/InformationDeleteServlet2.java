...
@WebServlet(value = "/information/delete32.action")
public class InformationDeleteServlet2 extends HttpServlet {
...
//		}
		...
		boardService.deleteBoardNo2(boardNo);
		
		//3. list.action으로 이동		 
		resp.sendRedirect("list32.action");		
	}
}
