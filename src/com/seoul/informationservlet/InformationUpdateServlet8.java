...
@WebServlet(value = "/information/update38.action")
public class InformationUpdateServlet8 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		Information board = boardService.findBoardByBoardNo8(boardNo);
			if (board == null) {
				resp.sendRedirect("/seoul/information/list38.action");
				return;
			}
		...
		RequestDispatcher dispatcher = 
			req.getRequestDispatcher("/WEB-INF/views/information/informationedit8.jsp");
