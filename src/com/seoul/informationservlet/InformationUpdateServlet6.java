...
@WebServlet(value = "/information/update36.action")
public class InformationUpdateServlet6 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		Information board = boardService.findBoardByBoardNo6(boardNo);
			if (board == null) {
				resp.sendRedirect("/seoul/information/list36.action");
				return;
			}
		...
		RequestDispatcher dispatcher = 
			req.getRequestDispatcher("/WEB-INF/views/information/informationedit6.jsp");
