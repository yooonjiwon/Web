...
@WebServlet(value = "/information/detail38.action")
public class InformationDetailServlet8 extends HttpServlet {
...
//		}
		...
		try {
			...
			resp.sendRedirect("/seoul/information/list38.action");
			return;
		}
		...
		Information information = boardService.findBoardByBoardNo8(boardNo);
			if (information == null) {
				resp.sendRedirect("/seoul/information/list38.action");
				return;
			}
		...
		boardService.increaseReadCount8(boardNo);
		...
		RequestDispatcher dispatcher = 
			req.getRequestDispatcher("/WEB-INF/views/information/informationdetail8.jsp");
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//사용자 수정 처리
		InformationBoardService boardService = new InformationBoardService();
		boardService.updateBoard8(board);
		resp.sendRedirect("/seoul/information/detail38.action?boardno=" + boardNo);
	}	
}
