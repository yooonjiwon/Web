...
@WebServlet(value = "/information/delete38.action")
public class InformationDeleteServlet8 extends HttpServlet {
...
//		}
		...
		boardService.deleteBoardNo8(boardNo);
		
		//3. list.action으로 이동		 
		resp.sendRedirect("list38.action");		
	}
}
