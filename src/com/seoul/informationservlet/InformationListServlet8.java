...
@WebServlet(value = "/information/list38.action")
public class InformationListServlet8 extends HttpServlet {
...
///////////////////////// 서비스로 넘겨 /////////////////////
		...
		List<Information> boards = boardService.findBoardList8(); //List<Board> : 리스트 목록이 한건이 아니고 여러건이기때문에 씀(복수처리)
		
		//페이저 기능도 서비스로 넘겨
		boardCount = boardService.getBoardCount8();
...
//////////////////////////////////////////////////////////////		
		...
		RequestDispatcher dispatcher = 
			req.getRequestDispatcher("/WEB-INF/views/information/informationlist8.jsp");
