...
@WebServlet(value = "/information/write37.action")
public class InformationWriteServlet7 extends HttpServlet {
...
//		}
		...
		RequestDispatcher dispatcher = 
			req.getRequestDispatcher("/WEB-INF/views/information/informationwrite7.jsp");
...
/*		String sBoardNo = req.getParameter("boardno");
		...
		boardService.writeBoard7(information);
