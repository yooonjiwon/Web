...
@WebServlet(value = "/information/list32.action")
public class InformationListServlet2 extends HttpServlet {
...
///////////////////////// 서비스로 넘겨 /////////////////////
		...
		List<Information> boards = boardService.findBoardList2(); //List<Board> : 리스트 목록이 한건이 아니고 여러건이기때문에 씀(복수처리)
...
//////////////////////////////////////////////////////////////
		...
		RequestDispatcher dispatcher = 
			req.getRequestDispatcher("/WEB-INF/views/information/informationlist2.jsp");
