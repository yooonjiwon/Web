...
@WebServlet(value = "/information/write35.action")
public class InformationWriteServlet5 extends HttpServlet {
...
//		}
		...
		RequestDispatcher dispatcher = 
			req.getRequestDispatcher("/WEB-INF/views/information/informationwrite5.jsp");
...
/*		String sBoardNo = req.getParameter("boardno");
		...
		boardService.writeBoard5(information);
