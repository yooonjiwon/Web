...
@WebServlet(value = "/information/detail35.action")
public class InformationDetailServlet5 extends HttpServlet {
...
//		}
		...
		Information information = boardService.findBoardByBoardNo5(boardNo);
			if (information == null) {
				resp.sendRedirect("/seoul/information/list35.action");
				return;
			}
		...
		boardService.increaseReadCount5(boardNo);
		...
		RequestDispatcher dispatcher = 
			req.getRequestDispatcher("/WEB-INF/views/information/informationdetail5.jsp");
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//사용자 수정 처리
		InformationBoardService boardService = new InformationBoardService();
		boardService.updateBoard5(board);
		resp.sendRedirect("/seoul/information/detail35.action?boardno=" + boardNo);
	}	
}
