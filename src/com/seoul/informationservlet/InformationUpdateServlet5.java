...
@WebServlet(value = "/information/update35.action")
public class InformationUpdateServlet5 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		Information board = boardService.findBoardByBoardNo5(boardNo);
			if (board == null) {
				resp.sendRedirect("/seoul/information/list35.action");
				return;
			}
		...
		RequestDispatcher dispatcher = 
			req.getRequestDispatcher("/WEB-INF/views/information/informationedit5.jsp");
