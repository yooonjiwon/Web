...
@WebServlet(value = "/information/update33.action")
public class InformationUpdateServlet3 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		Information board = boardService.findBoardByBoardNo3(boardNo);
			if (board == null) {
				resp.sendRedirect("/seoul/information/list33.action");
				return;
			}
		...
		RequestDispatcher dispatcher = 
			req.getRequestDispatcher("/WEB-INF/views/information/informationedit3.jsp");
